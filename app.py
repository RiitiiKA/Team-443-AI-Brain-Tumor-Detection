...
app = Flask(__name__)
model = load_model(r"C:\Users\RITIKA\Downloads\Team 443 Brain Tumor Detection\Team 443 Brain Tumor\SI-GuidedProject-4596-1626951146-main\SI-GuidedProject-4596-1626951146-main\Brain_Tumor.h5")
